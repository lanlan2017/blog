...
abbrlink: d5e5b83f
---
- [JSP request内置对象](/blog/html/d5e5b83f/#JSP-request内置对象)
    - [request对象常用方法](/blog/html/d5e5b83f/#request对象常用方法)
        - [获取请求体信息](/blog/html/d5e5b83f/#获取请求体信息)
        - [获取表单提交的参数](/blog/html/d5e5b83f/#获取表单提交的参数)
            - [枚举方式 遍历表单提交的数据](/blog/html/d5e5b83f/#枚举方式-遍历表单提交的数据)
                - [枚举方式 遍历表单提交的数据](/blog/html/d5e5b83f/#枚举方式-遍历表单提交的数据)
            - [Map方式 遍历表单提交的数据](/blog/html/d5e5b83f/#Map方式-遍历表单提交的数据)
                - [Map方式 遍历表单提交的数据](/blog/html/d5e5b83f/#Map方式-遍历表单提交的数据)
        - [操作request对象属性](/blog/html/d5e5b83f/#操作request对象属性)
        - [操作编码](/blog/html/d5e5b83f/#操作编码)
        - [服务器信息](/blog/html/d5e5b83f/#服务器信息)
        - [客户端信息](/blog/html/d5e5b83f/#客户端信息)
        - [获取请求头信息](/blog/html/d5e5b83f/#获取请求头信息)
        - [路径](/blog/html/d5e5b83f/#路径)
        - [其他信息](/blog/html/d5e5b83f/#其他信息)
    - [实例](/blog/html/d5e5b83f/#实例)
    - [表单输入中文乱码问题](/blog/html/d5e5b83f/#表单输入中文乱码问题)
        - [post方法乱码解决](/blog/html/d5e5b83f/#post方法乱码解决)
    - [超链接请求传参](/blog/html/d5e5b83f/#超链接请求传参)
        - [超链接传参语法](/blog/html/d5e5b83f/#超链接传参语法)
        - [实例](/blog/html/d5e5b83f/#实例)
    - [解决get方法提交(URL传参)中文乱码](/blog/html/d5e5b83f/#解决get方法提交-URL传参-中文乱码)
    - [requset对象其他方法实例](/blog/html/d5e5b83f/#requset对象其他方法实例)
        - [post提交方式](/blog/html/d5e5b83f/#post提交方式)
    - [参考链接](/blog/html/d5e5b83f/#参考链接)
