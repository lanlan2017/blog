...
abbrlink: ec8e0fb7
---
- [Java Web简介](/blog/html/ec8e0fb7/#Java-Web简介)
    - [什么是Web应用程序](/blog/html/ec8e0fb7/#什么是Web应用程序)
        - [常见web应用程序](/blog/html/ec8e0fb7/#常见web应用程序)
        - [目前软件开发领域的三大方向](/blog/html/ec8e0fb7/#目前软件开发领域的三大方向)
    - [静态网页与动态网页](/blog/html/ec8e0fb7/#静态网页与动态网页)
        - [静态网页](/blog/html/ec8e0fb7/#静态网页)
        - [动态网页](/blog/html/ec8e0fb7/#动态网页)
    - [搭建 Java Web开发环境](/blog/html/ec8e0fb7/#搭建-Java-Web开发环境)
        - [Tomcat安装步骤](/blog/html/ec8e0fb7/#Tomcat安装步骤)
        - [Tomcat版本和JDK版本之间的映射关系](/blog/html/ec8e0fb7/#Tomcat版本和JDK版本之间的映射关系)
        - [下载Tomcat](/blog/html/ec8e0fb7/#下载Tomcat)
        - [安装](/blog/html/ec8e0fb7/#安装)
        - [如何启动](/blog/html/ec8e0fb7/#如何启动)
        - [如何关闭](/blog/html/ec8e0fb7/#如何关闭)
        - [配置Tomcat环境变量](/blog/html/ec8e0fb7/#配置Tomcat环境变量)
        - [Tomcat服务器的目录结构](/blog/html/ec8e0fb7/#Tomcat服务器的目录结构)
    - [Tomcat中手动创建第一个Java Web项目](/blog/html/ec8e0fb7/#Tomcat中手动创建第一个Java-Web项目)
    - [WEB-INF目录详解](/blog/html/ec8e0fb7/#WEB-INF目录详解)
        - [验证客户端是否真的无法访问WEB-INF目录](/blog/html/ec8e0fb7/#验证客户端是否真的无法访问WEB-INF目录)
        - [web.xml配置文件](/blog/html/ec8e0fb7/#web-xml配置文件)
        - [修改欢迎界面](/blog/html/ec8e0fb7/#修改欢迎界面)
        - [classes文件夹](/blog/html/ec8e0fb7/#classes文件夹)
        - [lib文件夹](/blog/html/ec8e0fb7/#lib文件夹)
    - [Web项目的虚拟路径](/blog/html/ec8e0fb7/#Web项目的虚拟路径)
        - [eclipse中修改Web项目虚拟路径](/blog/html/ec8e0fb7/#eclipse中修改Web项目虚拟路径)
    - [参考链接](/blog/html/ec8e0fb7/#参考链接)
