...
abbrlink: 345f33d2
---
- [2.2 隐藏域](/blog/html/345f33d2/#2-2-隐藏域)
- [Demo](/blog/html/345f33d2/#Demo)
    - [完整代码](/blog/html/345f33d2/#完整代码)
    - [代码详解](/blog/html/345f33d2/#代码详解)
        - [根据用户id获取该用户对象的引用](/blog/html/345f33d2/#根据用户id获取该用户对象的引用)
            - [根据用户id获取该用户对象的引用](/blog/html/345f33d2/#根据用户id获取该用户对象的引用)
        - [输出HTML字符串到响应对象中](/blog/html/345f33d2/#输出HTML字符串到响应对象中)
            - [输出HTML字符串到响应对象中](/blog/html/345f33d2/#输出HTML字符串到响应对象中)
    - [小结](/blog/html/345f33d2/#小结)
