...
- [2.2 隐藏域](/blog/345f33d2/#2-2-隐藏域)
- [Demo](/blog/345f33d2/#Demo)
    - [完整代码](/blog/345f33d2/#完整代码)
    - [代码详解](/blog/345f33d2/#代码详解)
        - [根据用户id获取该用户对象的引用](/blog/345f33d2/#根据用户id获取该用户对象的引用)
            - [根据用户id获取该用户对象的引用](/blog/345f33d2/#根据用户id获取该用户对象的引用)
        - [输出HTML字符串到响应对象中](/blog/345f33d2/#输出HTML字符串到响应对象中)
            - [输出HTML字符串到响应对象中](/blog/345f33d2/#输出HTML字符串到响应对象中)
    - [小结](/blog/345f33d2/#小结)
