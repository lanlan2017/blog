...
abbrlink: 30442a1
---
- [2.4 Java Servlet 会话管理 通过HttpSession对象](/blog/html/30442a1/#2-4-Java-Servlet-会话管理-通过HttpSession对象)
    - [谁创建HttpSession对象](/blog/html/30442a1/#谁创建HttpSession对象)
    - [如何获取HttpSession对象](/blog/html/30442a1/#如何获取HttpSession对象)
    - [如何往HttpSession中存入数据](/blog/html/30442a1/#如何往HttpSession中存入数据)
    - [HttpSession中的数据要满足的条件](/blog/html/30442a1/#HttpSession中的数据要满足的条件)
    - [从HttpSession对象中取出数据](/blog/html/30442a1/#从HttpSession对象中取出数据)
    - [从HttpSession对象中批量取出数据](/blog/html/30442a1/#从HttpSession对象中批量取出数据)
    - [获取Http对象的标识](/blog/html/30442a1/#获取Http对象的标识)
    - [查看设置超时时间](/blog/html/30442a1/#查看设置超时时间)
- [Demo](/blog/html/30442a1/#Demo)
    - [Product](/blog/html/30442a1/#Product)
    - [ShoppingItem](/blog/html/30442a1/#ShoppingItem)
    - [ShoppingCartServlet](/blog/html/30442a1/#ShoppingCartServlet)
    - [代码详解](/blog/html/30442a1/#代码详解)
