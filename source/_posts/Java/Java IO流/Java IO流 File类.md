...
abbrlink: 833486b4
---
- [File类简介](/blog/html/833486b4/#File类简介)
- [File类方法](/blog/html/833486b4/#File类方法)
    - [继承关系](/blog/html/833486b4/#继承关系)
    - [字段](/blog/html/833486b4/#字段)
    - [构造函数](/blog/html/833486b4/#构造函数)
    - [判断方法](/blog/html/833486b4/#判断方法)
        - [详细说明：](/blog/html/833486b4/#详细说明：)
    - [创建文件或目录方法](/blog/html/833486b4/#创建文件或目录方法)
        - [当文件不存在时创建该文件](/blog/html/833486b4/#当文件不存在时创建该文件)
        - [当目录不存在时创建该目录:](/blog/html/833486b4/#当目录不存在时创建该目录)
    - [删除文件或目录](/blog/html/833486b4/#删除文件或目录)
    - [获取文件信息方法](/blog/html/833486b4/#获取文件信息方法)
    - [路径相关方法](/blog/html/833486b4/#路径相关方法)
        - [返回目录列表](/blog/html/833486b4/#返回目录列表)
