...
- [下载安装Xshell免费版](/blog/html/c3146b3e/#下载安装Xshell免费版)
    - [进入中文官网](/blog/html/c3146b3e/#进入中文官网)
    - [填写邮箱获取下载链接](/blog/html/c3146b3e/#填写邮箱获取下载链接)
    - [接收邮件 并下载](/blog/html/c3146b3e/#接收邮件-并下载)
- [使用Xshell创建秘钥](/blog/html/c3146b3e/#使用Xshell创建秘钥)
    - [Xshell创建秘钥详细过程](/blog/html/c3146b3e/#Xshell创建秘钥详细过程)
    - [保存公钥](/blog/html/c3146b3e/#保存公钥)
    - [导出私钥并保存](/blog/html/c3146b3e/#导出私钥并保存)
- [将Xshell创建的秘钥设置到Termux中](/blog/html/c3146b3e/#将Xshell创建的秘钥设置到Termux中)
    - [Termux 获得存储权限](/blog/html/c3146b3e/#Termux-获得存储权限)
    - [将公钥发送到手机上](/blog/html/c3146b3e/#将公钥发送到手机上)
    - [复制公钥到.ssh目录下](/blog/html/c3146b3e/#复制公钥到-ssh目录下)
    - [将公钥写入authorized_keys中](/blog/html/c3146b3e/#将公钥写入authorized-keys中)
- [开启sshd](/blog/html/c3146b3e/#开启sshd)
- [获取链接信息](/blog/html/c3146b3e/#获取链接信息)
    - [查看当前Termux用户信息](/blog/html/c3146b3e/#查看当前Termux用户信息)
    - [查看Termux的ip地址](/blog/html/c3146b3e/#查看Termux的ip地址)
        - [使用正则取出正确的IP所在的行](/blog/html/c3146b3e/#使用正则取出正确的IP所在的行)
- [确保手机和电脑在同一个网络下](/blog/html/c3146b3e/#确保手机和电脑在同一个网络下)
- [使用Xshell链接Termux](/blog/html/c3146b3e/#使用Xshell链接Termux)
    - [设置链接常规信息](/blog/html/c3146b3e/#设置链接常规信息)
    - [设置用户身份验证信息](/blog/html/c3146b3e/#设置用户身份验证信息)
    - [链接成功效果](/blog/html/c3146b3e/#链接成功效果)
        - [链接成功但是无法操作的情况](/blog/html/c3146b3e/#链接成功但是无法操作的情况)
        - [保证Termux显示在手机屏幕最上方](/blog/html/c3146b3e/#保证Termux显示在手机屏幕最上方)
    - [如何重新链接](/blog/html/c3146b3e/#如何重新链接)
    - [设置Termux常驻后台](/blog/html/c3146b3e/#设置Termux常驻后台)
- [参考资料](/blog/html/c3146b3e/#参考资料)
