...
abbrlink: 9e1b6b70
---
- [匹配一个合法的数字](/blog/html/9e1b6b70/#匹配一个合法的数字)
    - [三位数的情况：](/blog/html/9e1b6b70/#三位数的情况：)
    - [两位数的情况](/blog/html/9e1b6b70/#两位数的情况)
    - [一位数的情况](/blog/html/9e1b6b70/#一位数的情况)
    - [匹配一个合法的数字](/blog/html/9e1b6b70/#匹配一个合法的数字)
    - [优化：](/blog/html/9e1b6b70/#优化：)
- [匹配一个合法的数字和点号三次](/blog/html/9e1b6b70/#匹配一个合法的数字和点号三次)
- [最终的表达式：](/blog/html/9e1b6b70/#最终的表达式：)
    - [优化：](/blog/html/9e1b6b70/#优化：)
- [总结](/blog/html/9e1b6b70/#总结)
    - [匹配IP地址中的一个数](/blog/html/9e1b6b70/#匹配IP地址中的一个数)
