...
- [hexo d部署地址和.travis.yml书写的问题](/blog/13f63c39/#hexo-d部署地址和-travis-yml书写的问题)
    - [基于项目的Github Pages的写法](/blog/13f63c39/#基于项目的Github-Pages的写法)
        - [站点配置文件中仓库地址的写法](/blog/13f63c39/#站点配置文件中仓库地址的写法)
        - [正确的.travis.yml](/blog/13f63c39/#正确的-travis-yml)
        - [推送到master分支](/blog/13f63c39/#推送到master分支)
    - [基于xxxx.github.io仓库的配置](/blog/13f63c39/#基于xxxx-github-io仓库的配置)
        - [站点配置文件中仓库地址的写法](/blog/13f63c39/#站点配置文件中仓库地址的写法)
        - [正确的.travis.yml](/blog/13f63c39/#正确的-travis-yml)
        - [推送到src分支](/blog/13f63c39/#推送到src分支)
