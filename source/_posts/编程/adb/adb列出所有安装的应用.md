...
```cmd
adb -s 5d5ae6d7d shell pm list package |findstr /V android| findstr /V oppo| findstr /V com.coloros |findstr /V qualcomm| findstr /V google| findstr /V com.nearme
```
运行结果如下：
```cmd
C:\\Users\\haha>adb -s 5d5ae6d7d shell pm list package |findstr /V android| findstr /V oppo| findstr /V com.coloros |findstr /V qualcomm| findstr /V google| findstr /V com.nearme
...
## 示例
```cmd
D:\Desktop>adb -s 5d5ae6d7d shell pm list package -f |findstr /V android| findstr /V oppo| findstr /V com.coloros |findstr /V qualcomm| findstr /V google| findstr /V com.nearme| findstr /V bluetooth
...
```cmd
D:\Desktop>adb -s 5d5ae6d7d shell pm list packages -d
...
例如：
```cmd
adb -s 5d5ae6d7d shell pm list packages -e
```
省略。。。
...
例如：
```cmd
adb -s 5d5ae6d7d shell pm list packages -s
```
运行效果：
```cmd
D:\Desktop>adb -s 5d5ae6d7d shell pm list packages -s
...
## 示例
```cmd
D:\Desktop>adb -s 5d5ae6d7d shell pm list packages -3
package:com.jifen.qukan
...
```cmd
D:\Desktop>adb -s 5d5ae6d7d shell pm list packages -i
...
例如：
```cmd
D:\Desktop>adb -s 5d5ae6d7d shell pm list packages -e "com.taobao"
package:com.taobao.litetao
package:com.taobao.taobao
package:com.taobao.live
