---
title: adb命令进入WiFi设置界面
categories: 
  - 编程
  - adb
abbrlink: 3997c01a
date: 2023-05-02 16:20:05
updated: 2023-08-22 20:29:43
---
# adb打开Android手机WiFi设置界面
```
adb shell am start -n com.android.settings/.wifi.WifiSettings
```
如果还是打开之后闪退，则在start后面加上` -a android.intent.action.MAIN `选项，应该就可以了：
...
## 使用adb命令打开 OPPO手机 WiFi设置界面的activity
...
<!-- 
## 其他手机上
我在我的荣耀9青春版 手机上执行查询activity命令输出如下：
